...
⚠️ **ENGINEERING DISCLAIMER**: The typical values below are for **script prototyping and preliminary analysis only**. They are NOT suitable for:
...
**Always use site-specific geotechnical investigation data for professional engineering work.**

When user doesn't specify properties, use these typical values (with explicit disclaimer to user):
