...
## Template 1: Simple Circular Tunnel (Elastic Analysis)

```javascript
// Simple circular tunnel at depth
newmodel()
set("unit","stress-pa")
...
material("create","Mohr-Coulomb","matid",1,"matname","Rock",
  "density",2400,"shear",2e9,"bulk",3.3e9,"coh",1e5,"fric",40,"dil",0,"tens",1e4)
...
```javascript
// Simple slope stability analysis
newmodel()
set("unit","stress-pa")
